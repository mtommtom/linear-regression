...
can guarentee a reduction in the loss, it takes a very long time per epoch.
...
#### Analysis of results
The loss for each epoch on average, goes down. Unlike batch gradient descent which guagrentees there will be a decrease in
